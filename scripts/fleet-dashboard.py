...
<h2>2 · PAYG DeepSeek vs merges — la question du coût</h2>
<figure>{svg_dual_series(days, payg_day, merges_day, "réponses PAYG/jour", "merges/jour", "#c0392b", "#2c3e50")}<figcaption>Le PAYG (rouge, échelle gauche) vs la production mergée (bleu, échelle droite).
[M] Le PAYG suit les murs GLM (r = +0,697 horaire ; 98,5 % du trafic PAYG tombe pendant les heures de mur — #116, commentaire 15/09), pas le volume de production.</figcaption></figure>
...
<div class="int"><span class="mk">[I]</span><b>Le KPI PRs/M-réponses de ce dashboard est un proxy</b> tant que l'extraction OUT tokens n'est généralisée qu'à la lane native (native-trend.py). Le KPI exact est PRs/M-OUT et PRs/$ PAYG — c'est le travail P2 complet. À ne pas citer comme tokens.</div>
