...
import { getShortcuts } from "./provider-definitions.js";
...
describe("buildRoutingChain", () => {
  test("plain provider name 'minimax' uses originalModelName", () => {
...
describe("loadRoutingRules", () => {
  test("returns null or a RoutingRules object (never throws)", async () => {
    const result = await loadRoutingRules();
...
// ---------------------------------------------------------------------------
// getShortcuts / PROVIDER_TO_PREFIX sanity checks
// ---------------------------------------------------------------------------

describe("import consistency", () => {
  test("getShortcuts() maps 'mm' to 'minimax'", () => {
    const shortcuts = getShortcuts();
    expect(shortcuts["mm"]).toBe("minimax");
  });

  test("getShortcuts() maps 'kimi' to 'kimi'", () => {
    const shortcuts = getShortcuts();
