...
export function buildRoutingChain(
  ...
  for (const entry of entries) {
    ...
    // Resolve shortcut
    const provider = shortcuts[providerRaw.toLowerCase()] ?? providerRaw.toLowerCase();
